...
export class GenericTable {
    ...
    private deleteAllLambda: NodejsFunction | undefined;

    public createLambdaIntegration: LambdaIntegration;
    public readLambdaIntegration: LambdaIntegration;
    public updateLambdaIntegration: LambdaIntegration;
    public deleteLambdaIntegration: LambdaIntegration;
    public deleteAllLambdaIntegration: LambdaIntegration;
    ...
    private createLambdas() {
        ...
        if (this.props.deleteAllLambdaPath){
            this.deleteAllLambda = this.createSingleLambda(this.props.deleteAllLambdaPath)
            this.deleteAllLambdaIntegration = new LambdaIntegration(this.deleteAllLambda)
        }
    }
    ...
    private grantTableRights(){
        ...
        if (this.deleteAllLambda){
            this.table.grantWriteData(this.deleteAllLambda);
        }
    }
